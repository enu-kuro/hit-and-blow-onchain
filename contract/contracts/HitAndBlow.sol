...
contract HitAndBlow is Ownable {
    ...
    // If bot player's transactions are in the same block, latter transaction will fail because gas estimation is not correct.
    // latter one has extra operactions and gas estimation doesn't count it.
